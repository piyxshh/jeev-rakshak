...
export default function LoginPage() {
  ...
  return (
    ...
    {/* Main Shield Shape - Deep Blue */}
    <path 
      d="M50 2.5C23.76 2.5 2.5 23.76 2.5 50V90L50 97.5L97.5 90V50C97.5 23.76 76.24 2.5 50 2.5Z" 
      fill="#0D2B4D" 
    />
    
    {/* Stylized Cow Head Icon - White */}
    <path 
      d="M50 40C45 40 42 43 42 48V58H58V48C58 43 55 40 50 40ZM45 35C45 32 47 30 50 30C53 30 55 32 55 35V38H45V35ZM38 52H42V56H38V52ZM62 52H58V56H62V52Z" 
      fill="white"
    />
    
    {/* Health Plus Symbol - Green Accent */}
    <path 
      d="M70 20H75V25H80V30H75V35H70V30H65V25H70V20Z"
      fill="#38A169"
    />
  </svg>
</div>
        ...
        <div className="flex relative mt-8 pt-2">
            ...
            <div className={`absolute bottom-0 h-1 bg-green-500 transition-all duration-300 ${
                activeTab === 'signIn' ? 'left-0 w-1/2' : 'left-1/2 w-1/2 bg-orange-500'
            }`} />
            <button
        ...
        <div className="space-y-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              style={{ caretColor: '#38A169' }} // Custom caret color
            />
          </div>
          ...
          <div className="relative">
            ...
            <input
              type="password" // Crucial for hiding password input
        ...
        <div>
          <button
            ...
            disabled={loading || phone.length < 10 || password.length < 6} // Basic validation
